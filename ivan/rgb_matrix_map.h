#include "config.h"
    ...
    //Col n
    const uint8_t LED_LIST_FUNCCOLUMN[] = { LED_DEL, LED_PGUP, LED_PGDN, LED_END };

    //All letters
    const uint8_t LED_LIST_ALPHABET[] = { LED_A, LED_B, LED_C, LED_D, LED_E, LED_F, LED_G, LED_H, LED_I, LED_J, 
                                          LED_K, LED_L, LED_M, LED_N, LED_O, LED_P, LED_Q, LED_R, LED_S, 
                                          LED_T, LED_U, LED_V, LED_W, LED_X, LED_Y, LED_Z };

    const uint8_t LED_LIST_ARROWS[] = { LED_LEFT, LED_RIGHT, LED_UP, LED_DOWN };

    const uint8_t LED_LIST_BOTTOMROW[] = { LED_LCTL, LED_LWIN, LED_LALT, LED_SPC, LED_RALT, LED_FN, LED_RCTL };
    ...
    const uint8_t LED_STRAYS[] = { LED_TAB, LED_LSFT, LED_COMM, LED_DOT, LED_SLSH, LED_RSFT, LED_SCLN, LED_QUOT,
                                    LED_ENT, LED_LBRC, LED_RBRC, LED_BSLS };
